                ...
                <div className="col-lg-7">
                  ...
                  <div className="row mt-5">
                    ...
                    <div className="col-md-6 col-12 mb-4">
                      <div className="banner-icon-box d-flex justify-content-center align-items-center">
                        ...
                        <h6 className="ms-2">Boost your interview with tailored resume.</h6>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="banner-btn d-flex flex-column flex-md-row flex-lg-row gap-4 mt-4 mb-5">
                    ...
                    <div className="banner-btn-2">
                      <a href="#">Download Syllabus <i className="fa-solid fa-download"></i></a>
                    </div>
                  </div>
                </div>
...
<div className="col-lg-5 text-end">
  ...
  <select
    name="workExperience"
    className={`form-control home-select-input ${errors.workExperience ? "is-invalid" : ""}`}
    id="workExperience"
...
//     // Check if number has exactly 10-12 digits
//     if (
//       formData.number &&
...
//             );
//             // Clear form after successful submission
//             setFormData({ address: "", name: "", email: "", number: "", workExperience: "" });
//             setErrors({});
//           },
//           (error) => {
//             console.error("Failed to send email:", error);
...
//                         </span>
//                         <h6 className="ms-2">
//                           Collaborate with Professionals for Real Projects and Jobs
//                         </h6>
//                       </div>
//                     </div>
...
//                         </span>
//                         <h6 className="ms-2">
//                           Ace Your Interviews and Live Projects with IT Industry Experts
//                         </h6>
//                       </div>
//                     </div>
